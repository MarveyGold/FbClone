...
export namespace Prisma {
  ...
  */
  ...
  export type LoginOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "ID" | "Password" | "createdAt", ExtArgs["result"]["login"]>
  ...
  interface LoginFieldRefs {
    ...
    readonly ID: FieldRef<"Login", 'String'>
  ...
  export type LoginScalarWhereWithAggregatesInput = {
    ...
    ID?: StringWithAggregatesFilter<"Login"> | string
